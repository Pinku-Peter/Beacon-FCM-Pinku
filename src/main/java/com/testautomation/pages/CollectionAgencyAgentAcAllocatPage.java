...
String secondColumnValue;
 ...
 // Method to navigate to Agent Account Allocation page
    public void navigateToAgentAccountAllocation() {
        ...
        WebElement AccountsAllocationmainmenu = wait.until(ExpectedConditions.visibilityOfElementLocated(CollectionAgencyAgentAcAllocatRepo.AccountsAllocationmainmenu));
        ...
        WebElement AgentAccountAllocationsubmenu = wait.until(ExpectedConditions.visibilityOfElementLocated(CollectionAgencyAgentAcAllocatRepo.AgentAccountAllocationsubmenu));
        ...
        try {
            ...
            wait.until(ExpectedConditions.visibilityOfElementLocated(CollectionAgencyAgentAcAllocatRepo.Branch));
            Log.info("'Branch' field is visible. Page loaded successfully.");
        } catch (Exception e) {
            Log.error("Branch field not found. Page is not loaded completely. Throwing an exception.", e);
 ...
 // Method to validate the presence of fields on Agent Account Allocation page
    public boolean isAgentAccountAllocationPageDisplayed() {
        ...
        WebElement AgentAccountAllocationpageheader = driver.findElement(CollectionAgencyAgentAcAllocatRepo.AgentAccountAllocationpageheader);
        WebElement AssetCategory = driver.findElement(CollectionAgencyAgentAcAllocatRepo.AssetCategory);
        WebElement SMACategory = driver.findElement(CollectionAgencyAgentAcAllocatRepo.SMACategory);
        WebElement NPACategory = driver.findElement(CollectionAgencyAgentAcAllocatRepo.NPACategory);
        WebElement Zone_CO = driver.findElement(CollectionAgencyAgentAcAllocatRepo.Zone_CO);
        WebElement Region = driver.findElement(CollectionAgencyAgentAcAllocatRepo.Region);
        WebElement Branch = driver.findElement(CollectionAgencyAgentAcAllocatRepo.Branch);
        WebElement SchemeType = driver.findElement(CollectionAgencyAgentAcAllocatRepo.SchemeType);
        WebElement ProductType = driver.findElement(CollectionAgencyAgentAcAllocatRepo.ProductType);
        WebElement Os_Balance_Operator = driver.findElement(CollectionAgencyAgentAcAllocatRepo.Os_Balance_Operator);
        WebElement Os_Balance_text_field = driver.findElement(CollectionAgencyAgentAcAllocatRepo.Os_Balance_text_field);
        WebElement Overdue_to_EMI_Operator = driver.findElement(CollectionAgencyAgentAcAllocatRepo.Overdue_to_EMI_Operator);
        WebElement Overdue_to_EMI_text_field = driver.findElement(CollectionAgencyAgentAcAllocatRepo.Overdue_to_EMI_text_field);
        WebElement Overdue_Balance_Operator = driver.findElement(CollectionAgencyAgentAcAllocatRepo.Overdue_Balance_Operator);
        WebElement Overdue_Balance_text_field = driver.findElement(CollectionAgencyAgentAcAllocatRepo.Overdue_Balance_text_field);
        WebElement CollectionAgent = driver.findElement(CollectionAgencyAgentAcAllocatRepo.CollectionAgent);
        WebElement TypesofAccount = driver.findElement(CollectionAgencyAgentAcAllocatRepo.TypesofAccount);
        WebElement Searchbutton = driver.findElement(CollectionAgencyAgentAcAllocatRepo.Searchbutton);
        WebElement Resetbutton = driver.findElement(CollectionAgencyAgentAcAllocatRepo.Resetbutton);
        ...
        JavascriptExecutor js = (JavascriptExecutor) driver;
        WebElement AllocatedListbutton = driver.findElement(CollectionAgencyAgentAcAllocatRepo.AllocatedListbutton);
        ...
        WebElement CollectionAgent2 = driver.findElement(CollectionAgencyAgentAcAllocatRepo.CollectionAgent2);
        WebElement AllocationDate = driver.findElement(CollectionAgencyAgentAcAllocatRepo.AllocationDate);
        WebElement Allocatebutton = driver.findElement(CollectionAgencyAgentAcAllocatRepo.Allocatebutton);
        WebElement DeAllocatebutton = driver.findElement(CollectionAgencyAgentAcAllocatRepo.DeAllocatebutton);
        WebElement Downloadbutton = driver.findElement(CollectionAgencyAgentAcAllocatRepo.Downloadbutton);
        WebElement Closebutton = driver.findElement(CollectionAgencyAgentAcAllocatRepo.Closebutton);
    ...
    public void selectAssetCategory() throws InterruptedException {
        ...
        Log.info("Locating the Asset Category dropdown...");
        WebElement AssetCategory = wait.until(ExpectedConditions.elementToBeClickable(CollectionAgencyAgentAcAllocatRepo.AssetCategory));

        Log.info("Clicking on the Asset Category dropdown...");
        AssetCategory.click();

        Log.info("Waiting for Asset Category values to become visible...");
        WebElement AssetCategoryvalues = wait.until(ExpectedConditions.visibilityOfElementLocated(CollectionAgencyAgentAcAllocatRepo.AssetCategoryvalues));
    ...
    public void selectSmaCategory(String smaCategory) {
        ...
        WebElement SMACategory = wait.until(ExpectedConditions.elementToBeClickable(CollectionAgencyAgentAcAllocatRepo.SMACategory));
        SMACategory.click();
        Log.info("Clicked on SMA Category dropdown.");

        WebElement smaCategoryOption = wait.until(ExpectedConditions.elementToBeClickable(CollectionAgencyAgentAcAllocatRepo.SMA_Category_NPA_Category_CollectionAgent_value(smaCategory)));
    ...
    public void selectNpaCategory(String NpaCategory) {
        ...
        WebElement NPACategory = wait.until(ExpectedConditions.elementToBeClickable(CollectionAgencyAgentAcAllocatRepo.NPACategory));
        NPACategory.click();
        Log.info("Clicked on NPA Category dropdown.");

        WebElement npaCategoryOption = wait.until(ExpectedConditions.elementToBeClickable(CollectionAgencyAgentAcAllocatRepo.SMA_Category_NPA_Category_CollectionAgent_value(NpaCategory)));
    ...
    public void selectAccountType(String accountType) {
        ...
        WebElement TypesofAccount = wait.until(ExpectedConditions.elementToBeClickable(CollectionAgencyAgentAcAllocatRepo.TypesofAccount));
        TypesofAccount.click();
        Log.info("Clicked on 'Types of Account' dropdown.");

        WebElement accountTypeOption = wait.until(ExpectedConditions.elementToBeClickable(CollectionAgencyAgentAcAllocatRepo.Types_of_Account_Role_CollectionAgent_value(accountType)));
    ...
    public void clickSearchButon() throws InterruptedException {
        ...
        WebElement searchButton = wait.until(ExpectedConditions.elementToBeClickable(CollectionAgencyAgentAcAllocatRepo.Searchbutton));
        searchButton.click();
        Log.info("Search button clicked successfully.");
        ...
        Log.info("Scrolling to 'Allocated List' button...");
        WebElement allocatedListButton = wait.until(ExpectedConditions.visibilityOfElementLocated(CollectionAgencyAgentAcAllocatRepo.AllocatedListbutton));
    ...
    public List<String> getAllColumnValuesExcludingFirstTwo() {
        ...
        List<WebElement> columns = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(CollectionAgencyAgentAcAllocatRepo.Gridvalues));
    ...
    public boolean areFilterFieldsCleared() {
        ...
        try {
            WebElement assetCategory = wait.until(ExpectedConditions.presenceOfElementLocated(CollectionAgencyAgentAcAllocatRepo.AssetCategory));
            WebElement smaCategory = wait.until(ExpectedConditions.presenceOfElementLocated(CollectionAgencyAgentAcAllocatRepo.SMACategory));
            WebElement npaCategory = wait.until(ExpectedConditions.presenceOfElementLocated(CollectionAgencyAgentAcAllocatRepo.NPACategory));
            WebElement typesOfAccount = wait.until(ExpectedConditions.presenceOfElementLocated(CollectionAgencyAgentAcAllocatRepo.TypesofAccount));
            ...
            Log.error("One or more filter fields were not found on the page!", e);
            return false;
        }
    }
    ...
    public List<String> selectAccount() {
        ...
        try {
            ...
            Log.error("Timeout while waiting for elements: " + e.getMessage(), e);
        } catch (StaleElementReferenceException e) {
            Log.error("Element went stale while interacting: " + e.getMessage(), e);
        } catch (NoSuchElementException e) {
            Log.error("Unable to locate an element: " + e.getMessage(), e);
        }
    ...
    public String selectAgent() {
        ...
        try {
            ...
            WebElement collectionAgentDropdown = wait.until(ExpectedConditions.elementToBeClickable(CollectionAgencyAgentAcAllocatRepo.CollectionAgent2));
            ...
            List<WebElement> collectionAgentValues = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(CollectionAgencyAgentAcAllocatRepo.collectionagentvalues));
 ...
 // Method to click the Allocate button
    public void clickAllocateButon() {
        ...
        try {
            ...
            WebElement allocateButton = wait.until(ExpectedConditions.elementToBeClickable(CollectionAgencyAgentAcAllocatRepo.Allocatebutton));
            ...
            wait.until(ExpectedConditions.invisibilityOfElementLocated(CollectionAgencyAgentAcAllocatRepo.Allocatedmsg));
    ...
    public void selectAgent(String agentName) {
        ...
        WebElement AgentName = wait.until(ExpectedConditions.visibilityOfElementLocated(
            CollectionAgencyAgentAcAllocatRepo.SMA_Category_NPA_Category_CollectionAgent_value(agentName)
        ));
    ...
    public void clickDownloadButon() {
        ...
        wait.until(ExpectedConditions.invisibilityOfElementLocated(CollectionAgencyAgentAcAllocatRepo.downloadedmsg));
    ...
    public void selectAcount() {
        ...
        WebElement accountCheckbox = driver.findElement(CollectionAgencyAgentAcAllocatRepo.accountCheckbox);
    ...
    public void clickDeallocate() {
        ...
        wait.until(ExpectedConditions.invisibilityOfElementLocated(CollectionAgencyAgentAcAllocatRepo.deallocatedmsg));
    ...
    public boolean isPopupDisplayed() {
        ...
        try {
            ...
            WebElement allocatedlistpopup = driver.findElement(CollectionAgencyAgentAcAllocatRepo.allocatedlistpopup);
    ...
    public void selectAgentname(String agentName) {
        ...
        WebElement AgentNamedropdown = driver.findElement(CollectionAgencyAgentAcAllocatRepo.AgentName);
        AgentNamedropdown.click();

        // Wait for and select the specified agent
        Log.info("Waiting for the agent '" + agentName + "' to be visible...");
        WebElement AgentName = wait.until(ExpectedConditions.visibilityOfElementLocated(CollectionAgencyAgentAcAllocatRepo.Agent_Name(agentName)));
    ...
    public void enterActionDates(String Date) {
        ...
        WebElement ActionDateFrom = driver.findElement(CollectionAgencyAgentAcAllocatRepo.ActionDateFrom);
        ActionDateFrom.click();

        Log.info("Waiting for 'From' date (" + Date + ") to be visible...");
        WebElement FromDate = wait.until(ExpectedConditions.visibilityOfElementLocated(CollectionAgencyAgentAcAllocatRepo.ActionDate_From_and_To_value(Date)));
        ...
        WebElement ActionDateTo = driver.findElement(CollectionAgencyAgentAcAllocatRepo.ActionDateTo);
        ActionDateTo.click();

        Log.info("Waiting for 'To' date (" + Date + ") to be visible...");
        WebElement ToDate = wait.until(ExpectedConditions.visibilityOfElementLocated(CollectionAgencyAgentAcAllocatRepo.ActionDate_From_and_To_value(Date)));
 ...
 // Method to click the search button
    public void clickSearch() {
        ...
        Log.info("Locating the Search button...");
        WebElement Search = driver.findElement(CollectionAgencyAgentAcAllocatRepo.Search);
    ...
    public boolean verifyDateRange(String fromDate, String toDate) {
        ...
        List<WebElement> dateElements = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(CollectionAgencyAgentAcAllocatRepo.Allocationdates));
    ...
    public void clickResetButon() {
        ...
        WebElement ResetButton = driver.findElement(CollectionAgencyAgentAcAllocatRepo.Resetbuton);
        ResetButton.click();
    ...
    public boolean areFiltersReset() {
        ...
        // Locate elements
        WebElement AgentName = driver.findElement(CollectionAgencyAgentAcAllocatRepo.AgentName);
        WebElement ActionDateFrom = driver.findElement(CollectionAgencyAgentAcAllocatRepo.ActionDateFrom);
        WebElement ActionDateTo = driver.findElement(CollectionAgencyAgentAcAllocatRepo.ActionDateTo);
        WebElement Gridresetvalue = driver.findElement(CollectionAgencyAgentAcAllocatRepo.Gridresetvalue);
    ...
    public void selectAllocationId() {
        ...
        WebElement AllocationID = driver.findElement(CollectionAgencyAgentAcAllocatRepo.AllocationID);
        AllocationID.click();
 ...
 // Method to click on the Download in Excel button
    public void clickDownloadExcelButton() {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(180));
        WebElement downloadExcelButton = driver.findElement(CollectionAgencyAgentAcAllocatRepo.downloadExcelButton);
    ...
    public void enterActionsDates(String Date) {
        ...
        try {
            ...
            WebElement FromDate = wait.until(ExpectedConditions.visibilityOfElementLocated(CollectionAgencyAgentAcAllocatRepo.ActionDate_From_and_To_values(Date)));
            FromDate.click();
 ...
 // Method to click the Close button and close the popup
    public void closePopup() {
    	try {
            ...
            WebElement popupCloseBtn = wait.until(ExpectedConditions.elementToBeClickable(CollectionAgencyAgentAcAllocatRepo.allocatedlistpopupclosebtn));
            popupCloseBtn.click();
    ...
    public boolean isPopupDiplayed(boolean waitForClose) { 
    	try {
            if (waitForClose) {
                ...
                return wait.until(ExpectedConditions.visibilityOfElementLocated(CollectionAgencyAgentAcAllocatRepo.allocatedlistpopup)).isDisplayed();
            } else {
                return !driver.findElements(CollectionAgencyAgentAcAllocatRepo.allocatedlistpopup).isEmpty();
            }
        } catch (TimeoutException e) {
    ...
    public void clickCloseButton() {
        ...
        WebElement closeButton = wait.until(ExpectedConditions.elementToBeClickable(CollectionAgencyAgentAcAllocatRepo.Closebutton));
