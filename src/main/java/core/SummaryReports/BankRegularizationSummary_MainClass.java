...
private WebDriver driver;
 ...
 // Method to click on the search button
    ...
    public String getAccountCategory() {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(180));
        WebElement AccountCategory = wait.until(ExpectedConditions.visibilityOfElementLocated(BankRegularizationSummaryRepo.AccountCategory));
    ...
    public String getNoOfAccountsReceived() {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(180));
        WebElement accountsReceived = wait.until(ExpectedConditions.visibilityOfElementLocated(BankRegularizationSummaryRepo.accountsReceived));
    ...
    public String getTotalOSAmountReceived() {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(180));
        WebElement totalOSAmountsReceived = wait.until(ExpectedConditions.visibilityOfElementLocated(BankRegularizationSummaryRepo.totalOSAmountsReceived));
  ...
  public String getNoOfAccountsRegularized() {
	  Log.info("Waiting for visibility of Accounts Regularized element...");
	    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(180));
	    WebElement accountsRegularized = wait.until(ExpectedConditions.visibilityOfElementLocated(BankRegularizationSummaryRepo.accountsRegularized));
    ...
    public String getTotalOSAmountRegularized() {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(180));
        WebElement totalOSAmountsRegularized = wait.until(ExpectedConditions.visibilityOfElementLocated(BankRegularizationSummaryRepo.totalOSAmountsRegularized));
    ...
    public void clickDownloadButton() {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(180));
        WebElement downloadButton = wait.until(ExpectedConditions.visibilityOfElementLocated(BankRegularizationSummaryRepo.downloadButton));
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(BankRegularizationSummaryRepo.downloadsuccessmessage));
        ...
        wait.until(ExpectedConditions.invisibilityOfElementLocated(BankRegularizationSummaryRepo.downloadsuccessmessage));
