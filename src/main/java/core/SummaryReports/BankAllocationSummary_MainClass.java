...
private WebDriver driver;
	...
	public void selectSmaFromBranchAttention() {
	    ...
	    try {
	        ...
	        Log.error("Accounts not found. Please try again.", e);
	 ...
	 public void assignToBranch(String username) {
	    ...
	    public void fillMandatoryFields(String region, String branch, String fromDate, String toDate) {
	        ...
	        WebElement DateDropdownvalue = wait.until(ExpectedConditions.visibilityOfElementLocated(BankAllocationSummaryRepo.DateDropdownvalues(toDate)));
	    ...
	    public boolean areTodaysAllocationsDisplayed(List<String> accountNumbers) {
	        ...
	        try {
	            ...
	            Log.error("Displayed account count is not a valid number: " + displayedCountStr, e);
	            return false;
	        }
	    ...
	    public void downloadAsExcel() {
	        ...
	        WebElement Downloadbuttonfromgrid = wait.until(ExpectedConditions.visibilityOfElementLocated(BankAllocationSummaryRepo.Downloadbuttonfromgrid));
	        ...
	        wait.until(ExpectedConditions.visibilityOfElementLocated(BankAllocationSummaryRepo.Downloadsuccessmessage));
	        Log.info("Download success message appeared.");

	        Log.info("Waiting for download success message to disappear...");
	        wait.until(ExpectedConditions.invisibilityOfElementLocated(BankAllocationSummaryRepo.Downloadsuccessmessage));
	    ...
	    public boolean isExcelvaluesMatchingWithUI() {
	    	try {
	            ...
	            WebElement TOTAL_OS_AMOUNT_IN_LAKHSfromgrid = wait.until(ExpectedConditions.visibilityOfElementLocated(BankAllocationSummaryRepo.TOTAL_OS_AMOUNT_IN_LAKHSfromgrid));
	            ...
	            Log.error("Exception while comparing Excel and UI values: " + e.getMessage(), e);
	            return false;
	        }
	    }
