...
private WebDriver driver;
    ...
    public void enterAccountNumber(String accountNumber) throws InterruptedException { 
        ...
        WebElement accountNumberField = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.accountNumberField));
    ...
    public void clickGetButton() {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(180));
        WebElement getButton = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.getButton));
    ...
    public void selectMaskStatus(String value) {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(180));
        WebElement statusFieldDropdown = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.statusFieldDropdown));
        ...
        WebElement Dropdownvalues = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.Dropdownvalues(value)));
    ...
    public void selectAllAccountLife() {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(180));
        WebElement allAccountLifeRadioButton = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.allAccountLifeRadioButton));
    ...
    public void enterReason(String reason) {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(180));
        WebElement reasonField = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.reasonField));
    ...
    public void clickSaveButton() {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(180));
        WebElement saveButton = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.saveButton));
    ...
    public void confirmPopup() {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(180));
        WebElement confirmationPopupOkButton = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.confirmationPopupOkButton));
    ...
    public String getSuccessMessage() {
        ...
        try {
            WebElement successMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.successMessage));
 ...
 // Method to navigate to the Mask Authorization section
    public void navigateToMaskAuthorization() {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(180));
        WebElement maskAuthorizationOption = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.maskAuthorizationOption));
    ...
    public void searchMaskedAccount(String accountNumber) {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(180));
        WebElement maskedAccountNumberField = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.maskedAccountNumberField));
        ...
        WebElement searchButton = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.searchButton));
    ...
    public void approveRequest() throws InterruptedException {
        ...
        WebElement firstResult = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.firstResult));
        ...
        WebElement approvalButton = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.approvalButton));
    ...
    public String getapprovalSuccessMessage() {
        ...
        try {
            WebElement approvalSuccessMessage = wait.until(
                ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.approvalsuccessMessage)
            );

            Log.info("Approval success message displayed: " + approvalSuccessMessage.getText());
            return approvalSuccessMessage.getText();
        } catch (Exception e) {
            Log.error("Approval success message not displayed within the expected time.", e);
    ...
    public void navigateToNotificationManagement() {
        ...
        try {
            ...
            Log.error("Page navigation not displayed. Notification Management page did not load completely.", e);
    ...
    public void configureNotification(String notificationType, String template) throws InterruptedException {
        ...
        try {
            ...
            wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.validateButton));
            Log.info("'Validate' button is displayed successfully.");
        } catch (TimeoutException e) {
            Log.error("Validate button not displayed. Page did not load completely.", e);
    ...
    public String validateMaskedAccountNumber(String accountNumber) {
        ...
        WebElement maskedAccountInput = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.maskedAccountInput));
        Log.info("Masked account input field located. Entering account number...");
        maskedAccountInput.sendKeys(accountNumber);

        Log.info("Waiting for 'Validate' button to be visible...");
        WebElement validateButton = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.validateButton));
        Log.info("'Validate' button located. Clicking the button...");
        validateButton.click();

        Log.info("Waiting for warning message to be displayed...");
        WebElement warningMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.warningMessage));
 ...
 // Method to get error message text
    public String getErrorMessage() {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(180));
        WebElement errorMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.errorMessage));
    ...
    public boolean isErrorMessageDisplayed() {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(180));
        WebElement errorMsg = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.errorMsg));
    ...
    public String getErrorMegText() {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(180));
        WebElement errorMssg = wait.until(ExpectedConditions.visibilityOfElementLocated(CoreAlertsMaskAcAndMaskingAuthoRepo.errorMssg));
