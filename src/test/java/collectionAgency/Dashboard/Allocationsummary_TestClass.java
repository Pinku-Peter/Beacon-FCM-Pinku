...
import core.SummaryReports.BankRegularizationSummary_MainClass;

public class Allocationsummary_TestClass {
	...
	Allocationsummary_MainClass allocationsummary;
    ...
    public void setupTest(Method method) {
		...
		drivers.add(driver);
		allocationsummary = new Allocationsummary_MainClass(driver); 
